# @bootstrap-wc/plugin-tom-select

Tom Select rich select wrapper.

`<bs-search-select>` is a Lit-based web-component wrapper for [tom-select].
...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/@bootstrap-wc/plugin-tom-select/dist/define.js"></script>

<bs-search-select options='{"key": "value"}'>
...
- If you place `<bs-search-select>` inside another wc component (e.g. `<bs-modal>`),
