...
blueimp-gallery lightbox wrapper.

`<bs-lightbox>` is a Lit-based web-component wrapper for [blueimp-gallery].
...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/@bootstrap-wc/plugin-blueimp-gallery/dist/define.js"></script>

<bs-lightbox options='{"key": "value"}'>
...
- If you place `<bs-lightbox>` inside another wc component (e.g. `<bs-modal>`),
