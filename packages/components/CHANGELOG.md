...
- 15d0263: Add `<bs-table>`, a Bootstrap table styling wrapper.
...
- 0fe3786: `bs-list-group-item`: fix click navigation when item content is nested.
...
- 3f2f89b: `<bs-dropdown nav>` — render the trigger as a flat `<a class="nav-link dropdown-toggle">` instead of `<button class="btn btn-secondary dropdown-toggle">`.
