...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/@bootstrap-wc/plugin-c3/dist/define.js"></script>

<bs-c3-chart options='{"key": "value"}'>
...
- If you place `<bs-c3-chart>` inside another wc component (e.g. `<bs-modal>`),
