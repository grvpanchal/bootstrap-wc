# @bootstrap-wc/plugin-chartjs

Chart.js 4 wrapper.

`<bs-chart>` is a Lit-based web-component wrapper for [chart.js].
...
```bash
npm install @bootstrap-wc/plugin-chartjs chartjs
```

## Usage

```html
<script type="module" src="https://cdn.jsdelivr.net/npm/@bootstrap-wc/plugin-chartjs/dist/define.js"></script>

<bs-chart options='{"key": "value"}'>
...
- If you place `<bs-chart>` inside another wc component (e.g. `<bs-modal>`),
