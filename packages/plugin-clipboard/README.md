# @bootstrap-wc/plugin-clipboard

clipboard.js copy-to-clipboard wrapper.

`<bs-clipboard>` is a Lit-based web-component wrapper for [clipboard.js].
...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/@bootstrap-wc/plugin-clipboard/dist/define.js"></script>

<bs-clipboard options='{"key": "value"}'>
...
- If you place `<bs-clipboard>` inside another wc component (e.g. `<bs-modal>`),
