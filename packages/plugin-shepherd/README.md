# @bootstrap-wc/plugin-shepherd

Shepherd.js guided tour wrapper.

`<bs-tour>` is a Lit-based web-component wrapper for [shepherd.js].
...
```bash
npm install @bootstrap-wc/plugin-shepherd shepherd
```

## Usage

```html
<script type="module" src="https://cdn.jsdelivr.net/npm/@bootstrap-wc/plugin-shepherd/dist/define.js"></script>

<bs-tour options='{"key": "value"}'>
...
- If you place `<bs-tour>` inside another wc component (e.g. `<bs-modal>`),
