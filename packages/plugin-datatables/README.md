# @bootstrap-wc/plugin-datatables

DataTables wrapper as a web component.

`<bs-datatable>` is a Lit-based web-component wrapper for [datatables.net].
...
```bash
npm install @bootstrap-wc/plugin-datatables datatables
```

## Usage

```html
<script type="module" src="https://cdn.jsdelivr.net/npm/@bootstrap-wc/plugin-datatables/dist/define.js"></script>

<bs-datatable options='{"key": "value"}'>
...
- If you place `<bs-datatable>` inside another wc component (e.g. `<bs-modal>`),
