...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/@bootstrap-wc/plugin-rickshaw/dist/define.js"></script>

<bs-rickshaw-chart options='{"key": "value"}'>
...
- If you place `<bs-rickshaw-chart>` inside another wc component (e.g. `<bs-modal>`),
