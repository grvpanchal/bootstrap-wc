# @bootstrap-wc/plugin-easymde

EasyMDE markdown editor wrapper.

`<bs-markdown-editor>` is a Lit-based web-component wrapper for [easymde].
...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/@bootstrap-wc/plugin-easymde/dist/define.js"></script>

<bs-markdown-editor options='{"key": "value"}'>
...
- If you place `<bs-markdown-editor>` inside another wc component (e.g. `<bs-modal>`),
