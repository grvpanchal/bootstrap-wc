# @bootstrap-wc/plugin-chartist

Chartist 1 chart wrapper.

`<bs-chartist-chart>` is a Lit-based web-component wrapper for [chartist].
...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/@bootstrap-wc/plugin-chartist/dist/define.js"></script>

<bs-chartist-chart options='{"key": "value"}'>
...
- If you place `<bs-chartist-chart>` inside another wc component (e.g. `<bs-modal>`),
