# @bootstrap-wc/plugin-jstree

jsTree wrapper as a web component.

`<bs-tree>` is a Lit-based web-component wrapper for [jstree].
...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/@bootstrap-wc/plugin-jstree/dist/define.js"></script>

<bs-tree options='{"key": "value"}'>
...
- If you place `<bs-tree>` inside another wc component (e.g. `<bs-modal>`),
