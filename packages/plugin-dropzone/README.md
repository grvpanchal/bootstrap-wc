# @bootstrap-wc/plugin-dropzone

Dropzone 6 file upload wrapper.

`<bs-file-upload>` is a Lit-based web-component wrapper for [dropzone].
...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/@bootstrap-wc/plugin-dropzone/dist/define.js"></script>

<bs-file-upload options='{"key": "value"}'>
...
- If you place `<bs-file-upload>` inside another wc component (e.g. `<bs-modal>`),
