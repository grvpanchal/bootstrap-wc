...
`<bs-datepicker>` is a Lit-based web-component wrapper for [flatpickr].
...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/@bootstrap-wc/plugin-flatpickr/dist/define.js"></script>

<bs-datepicker options='{"key": "value"}'>
...
- If you place `<bs-datepicker>` inside another wc component (e.g. `<bs-modal>`),
