# @bootstrap-wc/plugin-peity

Peity inline chart wrapper.

`<bs-peity-chart>` is a Lit-based web-component wrapper for [peity].
...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/@bootstrap-wc/plugin-peity/dist/define.js"></script>

<bs-peity-chart options='{"key": "value"}'>
...
- If you place `<bs-peity-chart>` inside another wc component (e.g. `<bs-modal>`),
